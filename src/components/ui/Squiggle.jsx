// Hand-drawn arrow doodle, shared by the bag's captions and the helm's controls.
// The artwork points right at 0deg; rotation is applied about the centre of its
// own viewBox rather than via transform-origin, so it stays correct at any
// rendered size.
export const POINTS_UP = 262;
export const POINTS_DOWN = 90;
export const POINTS_LEFT = 180;
export const POINTS_RIGHT = 0;

export default function Squiggle({ className, rotate = POINTS_UP }) {
  return (
